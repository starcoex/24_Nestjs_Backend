/*
  ...
  - The values [Paid,Ready,Failed] on the enum `PortOne_status` will be removed. If these variants are still used in the database, this will fail.
...
ALTER TABLE `PortOne` MODIFY `createdAt` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `status` ENUM('Cancel', 'Payment') NOT NULL;
